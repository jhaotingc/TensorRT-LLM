...
#include "deepEpConfig.hpp"
#include "deepEpOpEvent.hpp"

#include <c10/cuda/CUDAStream.h>

namespace torch_ext
{
class Buffer : public torch::CustomClassHolder {
    // TLLM_CHECK_WITH_INFO(NUM_MAX_NVL_PEERS == 8, "The number of maximum NVLink peers must be 8");

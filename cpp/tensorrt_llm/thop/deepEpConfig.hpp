...
#include "tensorrt_llm/kernels/deepEpKernels/exception.cuh"
...
struct Config {
    ...
    size_t get_nvl_buffer_size_hint(size_t hidden_bytes, int num_ranks) const {
        ...
        num_bytes += num_channels * num_nvl_ranks * num_max_nvl_chunked_recv_tokens * tk::internode::get_source_meta_bytes();
    ...
    size_t get_rdma_buffer_size_hint(int64_t hidden_bytes, int num_ranks) const {
        ...
        num_bytes += num_channels * num_rdma_ranks * num_max_rdma_chunked_recv_tokens * tk::internode::get_source_meta_bytes() * 2;
